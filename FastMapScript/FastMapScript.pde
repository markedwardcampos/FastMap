...
void setup() {
    ...
    myFileName = "/Users/m/Documents/Dropbox/Coding/GitRepo/FastMap/FastMapScript/Example.txt";
    opencv.movie("/Users/m/Documents/Dropbox/Coding/GitRepo/FastMap/Video/Shapes.mp4",640,480);
//    opencv.capture(w,h);
...
//        text( counter+i,centroid.x+5, centroid.y-5 );
